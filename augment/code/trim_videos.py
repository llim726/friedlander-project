...
def trim_videos(vidpath, project_name, camera_n, vid_type):
    ...
    vid_og = vidpath
    vid_new = os.path.join(os.path.sep, cwd, project_name, dir_name+'_sync_'+'cam_'+str(camera_n)+'_'+vid_type+'.mp4') # Video path must not have any spacing in the path string
